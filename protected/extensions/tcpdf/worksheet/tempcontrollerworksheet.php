    ...
    public function printRows() {
        ...
        <table border="0">
            ...
            <tr>
                ...
                <td width="10">:</td>
                <td width="450">[&nbsp;&nbsp;&nbsp;] CALIBRATION &nbsp;&nbsp;&nbsp;[&nbsp;&nbsp;&nbsp;] PARTIAL &nbsp;&nbsp;&nbsp; [&nbsp;&nbsp;&nbsp;] On-site Calibration </td>
            </tr>
        </table>
        <table border="0">
            <tr>
        ...
        <table border="0">
            ...
            <tr><td height="5"></td></tr>
            <tr>
                <td width="540" style="text-align:justify;">The instrument was calibrated in accordance with HME-CM-101, “Calibration of Temperature Controller, Indicator, and Recorder”.
                </td>
            </tr>
        ...
        <table>
            ...
            <tr>
                <td width="20"></td>
                <td width="110">Displays/Chart</td>
